...
import logo from 'www/public/images/logoPhoenicisGame.png';
        ...
        >
            ...
            >
                <Stack flexDirection="row">
                    <img src={logo} alt="Image" height={30} width={30} />
                    <Typography variant='body2'>{t('title.corp')}</Typography>
                </Stack>
                <a href='/documents/productys.pdf' download><Typography variant='body2'>{t('title.agreements')}</Typography></a>
            </Stack>
